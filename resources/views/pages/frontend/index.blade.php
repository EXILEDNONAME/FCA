...
<html lang="en-US">
  <head>
    ...
    <link rel="profile" href="../gmpg.org/xfn/11.htm">
                ...
                <aside id="travel_login_register_from-2" class="widget widget_login_form">
                  ...
                  <div class="form_popup from_login" tabindex="-1">
                    <div class="inner-form">
                      ...
                      <h3>Login</h3>
                      <form name="loginform" id="loginform" action="home-3.html#" method="post">
                      ...
                      <a href="home-3.html#" title="Lost your password?" class="lost-pass">Lost your password?</a>
                    </div>
                  </div>
                        ...
                        <div class="item_content">
                          <div class="post_images">
                            ...
                            <div class="group-icon">
                              ...
                              <a href="home-3.html#" data-toggle="tooltip" data-placement="top" title="" data-original-title="Wildlife"><i class="flaticon-island"></i></a>
                            </div>
                          </div>
                        ...
                        <div class="container two-column-respon mg-top-6x mg-bt-6x">
                          ...
                          <div class="row">
                            <div class="wpb_column col-sm-4">
                              <div class="widget-icon-box widget-icon-box-base iconbox-center">
                                <div class="box-icon icon-image circle">
                                  <img src="https://html.physcode.com/travel/images/home/Map-Marker.png" alt="">
                                </div>
                            ...
                            <div class="wpb_column col-sm-4">
                              <div class="widget-icon-box widget-icon-box-base iconbox-center">
                                <div class="box-icon icon-image ">
                                  <img src="https://html.physcode.com/travel/images/home/Worldwide-Location.png" alt="">
                                </div>
                                <div class="content-inner">
                                  <div class="sc-heading article_heading">
                            ...
                            <div class="wpb_column col-sm-4">
                              <div class="widget-icon-box widget-icon-box-base iconbox-center">
                                <div class="box-icon icon-image ">
                                  <img src="https://html.physcode.com/travel/images/home/Hot-Air-Balloon.png" alt="">
                                </div>
                                <div class="content-inner">
                                  <div class="sc-heading article_heading">
                          ...
                          <div class="container">
                            ...
                            <div class="row">
                              <div class="col-sm-12 text-center padding-top-6x">
                                <a href="../themeforest.net/item/travel-html-tour-travel-html-template-for-travel-agency-and-tour-operator/19504894.htm" class="icon-btn" title="Tour HTML Template - Travel HTML Template" target="_blank">
                                        ...
                                        <div class="discounts-tour">
                                          <h3 style="color:#ffffff" class="discounts-title"> Special Tour in April, Discover Australia for 100 customers with
                                            ...
                                            <div class="col-sm-12 text-center padding-top-2x">
                                              <a href="home-3.html#" class="icon-btn"><i class="flaticon-airplane-4"></i> Get tour </a>
                                            </div>
                                          </div>
                                        </div>
                                        <div class="col-sm-2"></div>
                                              ...
                                              <div class="tour-reviews-item">
                                                ...
                                                <div class="reviews-item-content">
                                                  <h3 class="reviews-item-title">
                                                    <a href="home-3.html#">Canadian Rockies</a>
                                                  </h3>
                                                ...
                                                <div class="post_list_inner_content_unit">
                                                  ...
                                                  <div class="wrapper-meta">
                                                    ...
                                                    <div class="post_list_cats">
                                                      <a href="home-3.html#" rel="category tag">Technology</a>
                                                    </div>
                                                  </div>
                                    ...
                                    <div class="row">
                                      ...
                                      <aside class="col-sm-3 widget_text"><h3 class="widget-title">INFORMATION</h3>
                                        <div class="textwidget">
                                          <ul class="menu list-arrow">
                                            <li><a href="home-3.html#">Press Centre</a></li>
                                            <li><a href="home-3.html#">Travel News</a></li>
                                            <li><a href="home-3.html#">About Us</a></li>
                                            <li><a href="home-3.html#">Privacy Policy</a></li>
                                            <li><a href="home-3.html#">Contact Us</a></li>
                                          </ul>
                                        </div>
                                      </aside>
                                      <aside class="col-sm-3 widget_text"><h3 class="widget-title">Our Menu</h3>
                                        <div class="textwidget">
                                          <ul class="menu list-arrow">
                                            <li><a href="home-3.html#">About us</a></li>
                                            <li><a href="home-3.html#">Career</a></li>
                                            <li><a href="home-3.html#">Terms</a></li>
                                            <li><a href="home-3.html#">Privacy Policy</a></li>
                                      ...
                                      <aside id="text-5" class="widget_text">
                                        <div class="textwidget">
                                          <ul class="footer_menu">
                                            ...
                                            <li><a href="../www.instagram.com/physcode/physcode.html"><i class="fa fa-instagram"></i></a>
                                            </li>
                                          </ul>
                                        </div>
                                      </aside>
